...
- [haemilsia-rental-inspector 구현](project_rental_inspector_v1.md) — 2026-04-08 Railway 봇 자동 슬랙 점검 구현 완료
- [rental-inspection SKILL.md 분할](project_rental_inspection_split_v1.md) — 2026-04-15 1220줄 → 허브+rules/+docs/ 구조로 라우팅 허브화
- [Agent dispatch 파일 누락 방지 (B18)](feedback_agent_dispatch_files_v1.md) — 2026-04-15 빡센점검 Wave 2 실행 시 Wave 1 JSON 7개 경로 전부 첨부 강제
- [퇴거정산 진행중은 정상](feedback_rental_rule_inprogress_normal_v1.md) — 2026-04-15 rules/1 v3.3: R12·R16·R21·R24 "퇴거정산 진행중" → 정상 재분류 (오류 보고 제외)
