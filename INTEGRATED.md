...
- `naver-powerlink-advisor` v2.0 ⭐ — 네이버 파워링크 전문 운영 파트너 (5종 캠페인·키워드·소재·확장소재 13종·품질지수·입찰·성과·추적 마스터 + 진단 모드 + references 10/templates 5)
...
*자동 빌드: `build-integrated_v1.sh` v1.0 | 빌드 시각: 2026-04-30 10:36 KST | 원본: `~/.claude/*.md` (Git)*
